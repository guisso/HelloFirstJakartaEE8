...
@Transactional
@WebServlet(name = "PessoaServletOneToMany",
        urlPatterns = {"/PessoaServletOneToMany"})
public class PessoaServlet extends HttpServlet {

    @Inject
    private PessoaOneToManyBeanLocal pessoaOneToManyBean;
...
//    @Transactional
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        endereco3.setLogradouro("Rua Tês");
        ...
        // Ligação
        // !! Nova alocação para mesmo objeto
        ...
        pessoaOneToManyBean.save(pessoa2);
        ...
        Pessoa pessoa1Bd = pessoaOneToManyBean
                .find(pessoa1.getId());
        System.out.println("-> P1: " + pessoa1Bd);

        Pessoa pessoa2Bd = pessoaOneToManyBean
                .find(pessoa2.getId());
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PessoaServlet: Um-para-muitos</h1>");
